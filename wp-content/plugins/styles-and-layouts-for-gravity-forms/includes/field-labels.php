<?php
/**
 * Label controls for customizer.
 */

/* Start of Section */
	$wp_customize->add_section(
		'gf_stla_form_id_field_labels',
		array(
			'title' => 'Field Labels',
			'panel' => 'gf_stla_panel',
		)
	...
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-labels][display]',
		array(
			'default'   => false,
			'transport' => 'refresh',
			'type'      => 'option',
	...
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-labels][text-align]',
		array(
			'default'   => '',
	...
	// Font style buttons.
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-labels][font-style]',
		array(
			'default'   => 'bold',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	/* for pc */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-labels][font-size]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for tab */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-labels][font-size-tab]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for mobile */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-labels][font-size-phone]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for pc*/
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-labels][line-height]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for_tablet*/
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-labels][line-height-tab]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for mobile*/
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-labels][line-height-phone]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-labels][font-color]',
		array(
			'default'   => '',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-labels][asterisk-color]',
		array(
			'default'   => '',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			$wp_customize, // WP_Customize_Manager.
			'gf_stla_form_id_' . $current_form_id . '[field-labels][asterisk-color]', // Setting id.
			array( // Args, including any custom ones.
