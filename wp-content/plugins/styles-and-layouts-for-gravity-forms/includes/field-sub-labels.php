<?php
/**
 * Sub labels controls for customizer.
 */

/* Start of Section */
$wp_customize->add_section(
	'gf_stla_form_id_field_sub_labels',
	array(
		'title' => 'Sub Labels',
		'panel' => 'gf_stla_panel',
	)
...
$wp_customize->add_setting(
	'gf_stla_form_id_' . $current_form_id . '[field-sub-labels][visibility]',
	array(
		'default'   => false,
		'transport' => 'refresh',
		'type'      => 'option',
...
// Font style buttons.
$wp_customize->add_setting(
	'gf_stla_form_id_' . $current_form_id . '[field-sub-labels][font-style]',
	array(
		'default'   => '',
...
/* for pc*/
$wp_customize->add_setting(
	'gf_stla_form_id_' . $current_form_id . '[field-sub-labels][font-size]',
	array(
		'default'   => '',
		'transport' => 'refresh',
		'type'      => 'option',
	...
	/* for tablets */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-sub-labels][font-size-tab]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for phone */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-sub-labels][font-size-phone]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for pc*/
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-sub-labels][line-height]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for_tablet*/
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-sub-labels][line-height-tab]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for mobile*/
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-sub-labels][line-height-phone]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[field-sub-labels][font-color]',
		array(
			'default'   => '',
			'transport' => 'postMessage',
			'type'      => 'option',
